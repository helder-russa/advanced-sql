# Schema Context
# Adds schema context on top of guardrails and runs a complete agent.
...
# Fetching schema context from PostgreSQL
# tag::schema_context_func[]
...
# Runnable agent with schema context
async def main():
    global conn
