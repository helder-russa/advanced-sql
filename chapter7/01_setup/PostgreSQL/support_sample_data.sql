...
VALUES
  (
    ...
    ARRAY['prod_analytics_basic', 'prod_analytics_pro'],
    'en',
    TIMESTAMPTZ '2025-01-05 10:00:00+00'
  ),
  (
    'kb_slow_dashboards',
    ...
    ARRAY['prod_analytics_pro'],
    'en',
    TIMESTAMPTZ '2025-01-06 14:30:00+00'
  ),
  (
    ...
    ARRAY['prod_messaging', 'prod_messaging_premium'],
    'en',
    TIMESTAMPTZ '2025-01-07 09:15:00+00'
  );
...
VALUES
  (
    'tkt_1001',
    'cust_acme_bank',
    TIMESTAMPTZ '2025-01-08 09:05:00+00',
    'email',
  ...
  (
    'tkt_1002',
    'cust_acme_bank',
    TIMESTAMPTZ '2025-01-08 11:22:00+00',
    'chat',
  ...
  (
    'tkt_1003',
    'cust_northwind',
    TIMESTAMPTZ '2025-01-09 15:40:00+00',
    'email',
  ...
  (
    'tkt_1004',
    'cust_contoso',
    TIMESTAMPTZ '2025-01-09 16:05:00+00',
    'chat',
  ...
  (
    'tkt_1005',
    'cust_contoso',
    TIMESTAMPTZ '2025-01-10 08:50:00+00',
    'email',
